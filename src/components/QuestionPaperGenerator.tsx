        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] bg-gradient-to-r from-[#00f2fe] to-[#cf64ff] text-slate-950 px-2 py-0.5 rounded-full font-mono font-bold uppercase tracking-wider">VST v2.5</span>
            </div>
            ...
            {!paper ? (
              ...
              >
                ...
                <div className="flex gap-2.5 mt-6">
                  ...
                  <span className="text-[10px] font-mono text-slate-600 uppercase tracking-widest">VST Engine Idle link open</span>
                </div>
              </motion.div>
            ) : (
              ...
              >
                ...
                >
                  ...
                  <div className="border-b-4 border-slate-950 pb-5 mb-6 text-center select-text">
                    <div className="text-[10px] font-mono font-bold tracking-widest uppercase mb-1 opacity-60">VST GPT Evaluation Services</div>
                  ...
                  <div className="border-t border-slate-300/40 pt-6 mt-12 text-center text-[10px] font-mono text-slate-500 flex justify-between uppercase tracking-widest font-bold">
                    <span>Generated By VST curriculum AI</span>
